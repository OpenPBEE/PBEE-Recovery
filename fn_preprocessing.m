...
fnc_filters.exterior_safety_lf = strcmp(comp_ds_table.unit,'lf') & comp_ds_table.affects_envelope_safety; % Components with perimeter linear feet units
fnc_filters.exterior_safety_sf = strcmp(comp_ds_table.unit,'sf') & comp_ds_table.affects_envelope_safety; % Components with perimeter square feet units
fnc_filters.exterior_safety_all = fnc_filters.exterior_safety_lf | fnc_filters.exterior_safety_sf;

% Exterior Falling hazards
fnc_filters.ext_fall_haz_lf = strcmp(comp_ds_table.unit,'lf') & comp_ds_table.ext_falling_hazard; % Components with perimeter linear feet units
fnc_filters.ext_fall_haz_sf = strcmp(comp_ds_table.unit,'sf') & comp_ds_table.ext_falling_hazard; % Components with perimeter square feet units
...
fnc_filters.exterior_seal_lf = strcmp(comp_ds_table.unit,'lf') & comp_ds_table.damages_envelope_seal; % Components with perimeter linear feet units
fnc_filters.exterior_seal_sf = strcmp(comp_ds_table.unit,'sf') & comp_ds_table.damages_envelope_seal; % Components with perimeter square feet units
...
fnc_filters.int_fall_haz_lf = comp_ds_table.int_falling_hazard & strcmp(comp_ds_table.unit,'lf'); % Interior components with perimeter feet units
fnc_filters.int_fall_haz_sf = comp_ds_table.int_falling_hazard & (strcmp(comp_ds_table.unit,'sf') | strcmp(comp_ds_table.unit,'each')); % Interior components with area feet units (or each, which is just lights, which we take care of with the fraction affected area, which is probably not the best way to do it)
fnc_filters.int_fall_haz_bay = comp_ds_table.int_falling_hazard & strcmp(comp_ds_table.area_affected_unit,'bay'); % structural damage that does not cause red tags but affects function
fnc_filters.int_fall_haz_build = comp_ds_table.int_falling_hazard & strcmp(comp_ds_table.area_affected_unit,'building'); % structural damage that does not cause red tags but affects funciton (this one should only be tilt-ups)
...
fnc_filters.interior_function_lf = comp_ds_table.obstructs_interior_space & strcmp(comp_ds_table.unit,'lf'); 
fnc_filters.interior_function_sf = comp_ds_table.obstructs_interior_space & (strcmp(comp_ds_table.unit,'sf') | strcmp(comp_ds_table.unit,'each'));  
fnc_filters.interior_function_bay = comp_ds_table.obstructs_interior_space & strcmp(comp_ds_table.area_affected_unit,'bay') ;
fnc_filters.interior_function_build = comp_ds_table.obstructs_interior_space & strcmp(comp_ds_table.area_affected_unit,'building');  
...
% Water and Plumbing
fnc_filters.water_main = comp_ds_table.system == 6 & strcmp(comp_ds_table.service_location,'building') & comp_ds_table.impairs_system_operation;
fnc_filters.water_unit = comp_ds_table.system == 6 & strcmp(comp_ds_table.service_location,'unit') & comp_ds_table.impairs_system_operation; 

% HVAC
hvac_equip = comp_ds_table.system == 8 & ismember(comp_ds_table.subsystem_id,[15,16,17,18,19,20]);
fnc_filters.hvac_main = hvac_equip & strcmp(comp_ds_table.service_location,'building') & comp_ds_table.impairs_system_operation;
...
fnc_filters.hvac_duct_mains = comp_ds_table.system == 8 & comp_ds_table.subsystem_id == 4 & strcmp(comp_ds_table.service_location,'building') & comp_ds_table.impairs_system_operation;
...
fnc_filters.hvac_unit = hvac_equip & strcmp(comp_ds_table.service_location,'unit') & comp_ds_table.impairs_system_operation;
...
fnc_filters.hvac_duct_braches = comp_ds_table.system == 8 & comp_ds_table.subsystem_id == 4 & strcmp(comp_ds_table.service_location,'unit') & comp_ds_table.impairs_system_operation;
fnc_filters.hvac_in_line_fan = comp_ds_table.system == 8 & comp_ds_table.subsystem_id == 5 & strcmp(comp_ds_table.service_location,'unit') & comp_ds_table.impairs_system_operation; 
fnc_filters.hvac_duct_drops = comp_ds_table.system == 8 & comp_ds_table.subsystem_id == 6 & strcmp(comp_ds_table.service_location,'unit') & comp_ds_table.impairs_system_operation;
fnc_filters.hvac_vav_boxes = comp_ds_table.system == 8 & comp_ds_table.subsystem_id == 7 & strcmp(comp_ds_table.service_location,'unit') & comp_ds_table.impairs_system_operation;
