...
for tu = 1:num_stories
    ...
    for i = 1:num_repair_time_increments
        ...
        required_stairs_w_fs = max(1,analysis_options.egrees_threshold .* building_model.stairs_per_story(tu)); 
        required_stairs_wo_fs = max(1,analysis_options.egrees_threshold_wo_fs .* building_model.stairs_per_story(tu));
