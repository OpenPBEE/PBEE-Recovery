function [impeding_factors] = main_impeding_factors(damage, ...
    ...
    building_value, impeding_factor_medians)
...
rapid_permit_filt = strcmp(damage.comp_ds_info.permit_type, 'rapid');
full_permiting_filt = strcmp(damage.comp_ds_info.permit_type, 'full');
...
if impedance_options.include_impedance.inspection
    duration.inspection = fn_inspection( ...
        ...
        impedance_options.surge_factor, sys_repair_trigger.any, ...
...
if impedance_options.include_impedance.permitting
    duration.permitting = fn_permitting( num_reals, ...
        impedance_options.surge_factor, sys_repair_trigger, trunc_pd, ...
...
if impedance_options.include_impedance.engineering
    [ duration.eng_mob, duration.design ] = fn_engineering( num_reals, ...
        repair_cost_ratio, building_value, impedance_options.surge_factor, ...
