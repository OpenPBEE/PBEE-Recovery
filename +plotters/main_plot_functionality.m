...
p_val = prctile(fr_time,p_gantt);
p_idx = find(abs(fr_time - p_val) == min(abs(fr_time - p_val)),1); % Find the index of the first realization that matches the selected percentile
